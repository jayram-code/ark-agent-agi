...
class GoogleSearchTool(BaseTool):
    ...
    def __init__(self, api_key: Optional[str] = None, search_engine_id: Optional[str] = None):
        ...
        """
        super().__init__(name="google_search", description="Search the web using Google")
    ...
    def search(self, query: str, num_results: int = 5, **kwargs) -> Dict[str, Any]:
        ...
        if not self.api_key or not self.search_engine_id:
            log_event(
                "GoogleSearchTool",
                {"event": "search_failed", "error": "missing_credentials", "query": query},
            )
            return {
                "success": False,
        ...
        try:
            ...
            log_event(
                "GoogleSearchTool",
                {"event": "search_started", "query": query, "num_results": num_results},
            )
            ...
            log_event(
                "GoogleSearchTool", {"event": "search_error", "query": query, "error": error_msg}
            )
            ...
            log_event(
                "GoogleSearchTool",
                {"event": "search_unexpected_error", "query": query, "error": error_msg},
            )

            return {"success": False, "error": error_msg, "query": query, "results": []}
