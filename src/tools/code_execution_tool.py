...
class CodeExecutionTool(BaseTool):
    ...
    def __init__(self, timeout_seconds: int = 10, max_output_chars: int = 10000):
        ...
        """
        super().__init__(name="code_execution", description="Execute Python code safely")
    ...
    async def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        Args:
            ...
            allow_imports (bool): Whether to allow imports (default: False)
        """
        return self.run_code(kwargs.get("code", ""), kwargs.get("allow_imports", False))

    def run_code(self, code: str, allow_imports: bool = False) -> Dict[str, Any]:
        """
    ...
    def execute_safe(self, code: str) -> Dict[str, Any]:
        ...
        Returns:
            Execution results
        """
        return self.run_code(code, allow_imports=False)
    ...
    def execute_with_libraries(self, code: str) -> Dict[str, Any]:
        ...
        Returns:
            Execution results
        """
        return self.run_code(code, allow_imports=True)
...
def execute_code(code: str, allow_imports: bool = False) -> Dict[str, Any]:
    ...
    """
    return code_executor.run_code(code, allow_imports)
