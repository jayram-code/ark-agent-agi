    ...
    async def receive(self, message: AgentMessage):
        ...
        for attempt in range(1, max_retries+1):
            ...
            try:
                ...
                elif hasattr(last_result, 'payload'): # If it's an AgentMessage but not pydantic model yet (unlikely)
                ...
                validation_errors.append({"attempt": attempt, "error": f"validator_exception: {str(e)}"})
