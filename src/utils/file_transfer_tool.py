...
class FileTransferTool:
    ...
    def __init__(self, upload_dir: str = "data/uploads", download_dir: str = "data/downloads"):
        ...
        log_event(
            "FileTransferTool",
            {"event": "initialized", "upload_dir": upload_dir, "download_dir": download_dir},
        )
    ...
    def upload_file(self, filename: str, content: bytes) -> Dict[str, Any]:
        ...
        try:
            ...
            log_event(
                "FileTransferTool",
                {"event": "file_uploaded", "filename": filename, "size": file_size},
            )
            ...
            log_event(
                "FileTransferTool", {"event": "upload_error", "filename": filename, "error": str(e)}
            )
    ...
    def download_file(self, filename: str) -> Dict[str, Any]:
        ...
        try:
            ...
            log_event(
                "FileTransferTool",
                {"event": "file_downloaded", "filename": filename, "size": file_size},
            )
            ...
            log_event(
                "FileTransferTool",
                {"event": "download_error", "filename": filename, "error": str(e)},
            )
            return {"success": False, "error": str(e), "filename": filename}
