...
class AgentController:
    ...
    def pause_agent(self, agent_name: str) -> Dict[str, Any]:
        ...
        if agent_name in self.paused_agents:
            log_event("AgentController", {
                "event": "pause_agent_already_paused",
                "agent": agent_name
            })
            return {
                "success": False,
    ...
    def get_all_statuses(self) -> Dict[str, Dict[str, Any]]:
        ...
        """
        all_agents = set(self.paused_agents) | set(self.message_queues.keys()) | set(self.agent_stats.keys())
