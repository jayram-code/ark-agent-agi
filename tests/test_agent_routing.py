...
class MockAgent(BaseAgent):
    ...
    async def receive(self, message: AgentMessage):
        ...
        return {"status": "success", "agent": self.name, "received_id": message.id}
...
class TestAgentRouting(unittest.TestCase):
    ...
    def test_unknown_agent(self):
        ...
        message = self.orc.new_message(
            sender="test", receiver="unknown_agent", type=MessageType.TASK_REQUEST, payload={}
        )
    ...
    def test_message_trace_id(self):
        ...
        message = self.orc.new_message(
            sender="test", receiver="agent1", type=MessageType.TASK_REQUEST, payload={}
        )
    ...
    def test_pause_resume_routing(self):
        ...
        message = self.orc.new_message(
            sender="test", receiver="agent1", type=MessageType.INFO, payload={"test": "data"}
        )
